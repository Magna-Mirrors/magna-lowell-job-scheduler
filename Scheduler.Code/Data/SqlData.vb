...
Public Class SqlData
    ...
    Private Const LineQuery As String = "Select Case [Id],[LineName],[LineDefinition],[MaxConcurrentLogins],[Wcfpath],[SelectCmd],[SchedulePath],[SchedularMethod]
                                 From [dbo].[eqp_Lines]"
            ...
            Using dRead As IDataReader = Cmd.ExecuteReader()
                While dRead.Read
                    ...
                    With Itm
                        ...
                        .WcfPath = dRead("Wcfpath")
                        .SchedulePath = dRead("SchedulePath")
                    End With
                    Rslt.Lines.Add(Itm)
                End While
            End Using
