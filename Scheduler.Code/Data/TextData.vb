...
Public Class TextData
    ...
    Public Sub New(ApTool As AppTools)
        _AppTools = ApTool
    End Sub
    ...
    Private Function GetPlanTxtFileData(ByRef Resp As GetPlanResponse, LineData As Line) As Boolean
        ...
        Dim filename As String = Path.Combine(LineData.SchedulePath, FName)
    ...
    Public Function SavePlan(Req As SavePlanRequest) As TransactionResult
        'TODO: get PlanData-------------------------------------
        Dim Rslt As TransactionResult
        Dim filename As String = Path.Combine(Req.LineData.SchedulePath, "plan.txt")
        If File.Exists(filename) Then
