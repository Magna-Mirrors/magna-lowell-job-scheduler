...
Public Class frmSchedule
    ...
    Private Function LoadSchedule(SchedulePath As String) As Boolean
        Dim filename As String = Path.Combine(SchedulePath, My.Settings.ScheduleFile)
    ...
    Public Sub Approve()
        ...
        If Me.TreeView1.SelectedNode.Name.StartsWith("L") Then
            ...
            If Lines.Tables(0).Rows.Contains(LineID) Then
                ...
                Dim WCFPath As String = thisLine.Item(3).ToString
                Dim SQLCall As String = thisLine.Item(4).ToString
                Dim WCF As New clsSnapShot(WCFPath, SQLCall)
